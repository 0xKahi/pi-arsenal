...
- **WHEN** the connected hub's membership or member status changes while its detail view is open
- **THEN** the open detail view reflects the new live roster or status without requiring the user to close and reopen the modal
